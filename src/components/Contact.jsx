...
const Contact = () => {
  return (
    <section name="contact" className="hero-background" style={{ minWidth: '100%', minHeight: '100vh' }}>
      <div className="container-lg px-4 d-flex flex-column justify-content-start gap-3" style={{ paddingTop: '80px', width: '80%', backgroundSize: 'cover' }}>
        <div className='d-flex flex-column justify-content-center' style={{ marginBottom: '1px' }}>
          <p className="py-5" style={{ fontWeight: '700', color: 'white', fontSize: '36px', lineHeight: '40px' }}>Contact</p>
          <p className='pb-1' style={{ color: 'white', fontSize: '20px', lineHeight: '28px' }}>Submit the form below to get in touch with me</p>
        </div>

        <div className='d-flex mb-3'>
          <form action="https://getform.io/f/76189781-39d5-42c0-8193-8ec3b85d6f28" method="POST" className="container mx-auto">
            ...
            <div className='row justify-content-center'>
              <button className="rounded btn btn-primary mb-4 col-6 col-md-2 col-lg-2">
                Let's talk
              </button>
            </div>
          </form>
